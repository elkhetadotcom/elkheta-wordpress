	...
	<div class="bb-mobile-header flex align-items-center">
		...
		<div class="header-aside">
			...
			<?php }else{ ?>
    			...
    			<!-- points in header -->
<!--     			<a href="<?php echo site_url(); ?>/win" title="اكسب مع موقع الخطة">
	    			<div class="points_header">
	    				<?php echo _e( 'رصيدك', 'buddyboss-theme' )." "; ?>

	    				<?php echo do_shortcode("[saffi_user_stats show='remaining_points']"); ?>

	    				<?php echo " "._e( 'جنيها', 'buddyboss-theme' ); ?>
	    			</div>
	    		</a> -->
    			<!-- points in header -->
