angular.module('usinApp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/user-list/filter-combined.html',
    ...
    "				option-val=\"name\" ng-change=\"doOnFieldSelected(i, item.id)\" disabled-choices=\"disabledItems\" class=\"usin-select-medium\"></usin-select-field>\n" +
    "			\n" +
    ...
    "					<!-- filter by text -->\n" +
    "					<span class=\"usin-combined-filter-word\">{{strings.contains}}</span><input type=\"text\" ng-model=\"item.val\">\n" +
    "				</span>\n" +
    "			\n" +
  ...
  $templateCache.put('views/user-list/profile.html',
    ...
    "						<!--SEPARATORS: -->\n" +
    "						<div ng-if=\"field.isSeparator\" class=\"usin-profile-separator\">\n" +
    "							<span class=\"usin-profile-separator-icon usin-field-icon usin-icon-field\"></span>\n" +
    ...
    "				<li ng-repeat=\"item in activityItems\" ng-init=\"userActivity = getUserActivity(item.id)\" ng-class=\"['usin-activity-item', 'usin-activity-item-'+item.id]\" ng-hide=\"item.isMissing\"\n" +
    ...
    "								<span ng-class=\"['usin-act-icon', 'usin-field-icon', {'usin-icon-{{userActivity.icon}}':userActivity.icon, 'usin-icon-field': !userActivity.icon}]\"></span>\n" +
    "								<span ng-if=\"!userActivity.hide_count && userActivity.count\" class=\"usin-act-title-count\">{{userActivity.count}}</span>{{userActivity.label}}\n" +
    "							</h4>\n" +
    "\n" +
    "							<div class=\"usin-profile-settings-actions\" ng-if=\"settings.editing\">\n" +
