		...
		<tbody>
			...
			<tr>
				...
				<td>
					...
					<span class="description wpcdt-pro-feature"><?php esc_html_e('For more designs. ', 'countdown-timer-ultimate'); ?> <?php echo sprintf( __( '<a href="%s" target="_blank">Upgrade to Premium</a>', 'countdown-timer-ultimate'), WPCDT_PRO_LINK); ?></span>
				</td>
			</tr>
			<tr>
				<th>
