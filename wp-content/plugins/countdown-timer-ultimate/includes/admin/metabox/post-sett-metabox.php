			...
			<tbody>
				...
				<tr class="wpcdt-pro-feature">
					...
					<td>
						...
						<?php echo sprintf( __( '<a href="%s" target="_blank">Upgrade to Premium</a>', 'countdown-timer-ultimate'), WPCDT_PRO_LINK); ?>
					</td>
				</tr>
				<tr>
					<th>
				...
				<tr class="wpcdt-pro-feature">
					<th colspan="2">
						<div class="wpcdt-sub-sett-title"><i class="dashicons dashicons-admin-generic"></i> <?php _e('Design Common Settings   ', 'countdown-timer-ultimate'); ?>
						<?php echo sprintf( __( '<a href="%s" target="_blank">Upgrade to Premium</a>', 'countdown-timer-ultimate'), WPCDT_PRO_LINK); ?></div>
					</th>
				</tr>
				<tr class="wpcdt-pro-feature">
